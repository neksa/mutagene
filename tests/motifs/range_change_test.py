...
class MyTestCase(unittest.TestCase):
    ...
    def test_something(self):
        mymotifs = {"motif": "TCT", "position": 1, "ref": "C", "alt": "G"}
        ...
        assert (
            observed_long["bases_mutated_not_in_motif"]
            == observed_short["bases_mutated_not_in_motif"]
        )
        assert (
            observed_long["bases_not_mutated_in_motif"]
            == observed_short["bases_not_mutated_in_motif"] + 2
        )
