...
@pytest.mark.parametrize("contingency_table", make_contingency_table(np.array([[0, 10], [40, 60]])))
...
@pytest.mark.parametrize("contingency_table", make_contingency_table(np.array([[0, 0], [40, 60]])))
