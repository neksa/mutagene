# import unittest
# import numpy as np
# from final_maf_code import process_mutations


# def testing_mut(self):
#     observed = process_mutations("CGA-2F-A9KP-01.maf.txt", "TCW", 1, "C", "K", 50, assembly=37)
...
#     observed1 = process_mutations("test_mutations.txt", "TCW", 1, "C", "K", 50, assembly=37)
...
#     observed2 = process_mutations("test_mut.txt", "CTT", 1, "T", "C", 1, assembly=37)
...
#     observed3 = process_mutations("test_mut.txt", "TCA", 1, "C", "A", 1, assembly=37)
