...
class AmbiguousTestCase(unittest.TestCase):
    ...
    def test_ambiguous(self):
        ...
        assert (
            matches["bases_mutated_in_motif"]
            == input_values_1["bases_mutated_in_motif"] + input_values_2["bases_mutated_in_motif"]
        )
        ...
        assert (
            input_values_2["bases_not_mutated_not_in_motif"]
            == matches["bases_not_mutated_not_in_motif"]
        )
        assert (
            input_values_2["bases_not_mutated_not_in_motif"]
            == input_values_1["bases_not_mutated_not_in_motif"]
        )
