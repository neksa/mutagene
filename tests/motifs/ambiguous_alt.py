...
class MyTestCase(unittest.TestCase):
    ...
    def test_something(self):
        ...
        assert int(matches['bases_mutated_in_motif']) == expected[0] \
            and int(matches['bases_mutated_not_in_motif']) == int(input_values_1['bases_mutated_not_in_motif']) == int(input_values_2['bases_mutated_not_in_motif']) \
            and int(input_values_2['bases_not_mutated_not_in_motif']) == int(matches['bases_not_mutated_not_in_motif']) == int(input_values_1['bases_not_mutated_not_in_motif'])
